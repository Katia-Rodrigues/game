...
- **Popup de Vitória**: Exibe uma medalha e uma mensagem de parabéns quando o jogador vence o jogo.
...
![Tela de Login](./images/tela-principal.PNG)
...
![Popup de Vitória](./images/screenshot-popup.png)

Descrição do popup de vitória. Exibe uma medalha e uma mensagem de parabéns quando você ganha o jogo.
...
4. **Complete o jogo** antes que o tempo acabe para ganhar. Se vencer, um popup com uma medalha será exibido.
